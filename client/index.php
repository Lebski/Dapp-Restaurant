...
<html lang="en">
  ...
  <head>
	...
	<script type="text/javascript" src="bc_handler.js"></script>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">DeineLieblingsbar</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Ethereum</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Willkommen in deiner LieblingsBar!</div>
          <div class="intro-heading text-uppercase">Pay with Ethereum!</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Los geht's!</a>
        </div>
      </div>
    </header>
    ...
    <section id="services">
      <div class="container">
        ...
        <div class="row text-center">
          ...
          <div class="col-md-3" style="margin-bottom:10%">
		    <div class="test">
				...
				<div class="footer">
					...
					<select class="select-amount" id="select0">
          ...
          <div class="col-md-3" style="margin-bottom:10%">
			<div class="test">
				...
				<div class="footer">
					...
					<select class="select-amount" id="select1">
						<option value="none">-- Amount --</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
          ...
          <div class="col-md-3" style="margin-bottom:10%">
		  <div class="test">
            <img src="https://media.gqindia.com/wp-content/uploads/2014/10/gq-flaming-cocktails_0-866x487.jpg" alt="rhcp"/>
			...
			<div class="footer">
				...
				<select class="select-amount" id="select2">
					<option value="none">-- Amount --</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
		  ...
		  <div class="test">
			...
			<div class="footer">
				...
				<select class="select-amount" id="select3">
					<option value="none">-- Amount --</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
		...
		<div class="row" style="margin-top:-5%">
			<div class="col-lg-6">
				...
				<button onclick="buyCoctail()" style="margin-left:40px;">Buy</button>
    ...
    <section class="bg-light" id="team">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Unser LieblingsBar-Team</h2>
            <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
          </div>
        </div>
        <div class="row">
	...
	<script>
		...
		function buyCoctail(){
			var cocktail0 = document.getElementById("select0").value;
			var cocktail1 = document.getElementById("select1").value;
			var cocktail2 = document.getElementById("select2").value;
			var cocktail3 = document.getElementById("select3").value;

			var table = document.getElementById("table").value;

			if(table != "none"){
				if(cocktail0 != "none" || cocktail1 != "none" || cocktail2 != "none" || cocktail3 != "none" ){
					$.post('../client/writedb.php', {cocktail0: cocktail0, cocktail1: cocktail1, cocktail2: cocktail2,cocktail3: cocktail3,table: table});
					//$.post('../client/writedb.php', {drinks: "{zombie: " +cocktail0 +", wodka: " +cocktail1 +", tequila: " +cocktail2 +", jimbean: " +cocktail3 +"}",table: table});
					alert("Transaction to server successful. \nEdit this modal after web3-integration.");					
