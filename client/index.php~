        ...
        <div class="row text-center">
          ...
          <div class="col-md-3" style="margin-bottom:10%">
		    <div class="test">
				...
				<div class="footer">
					...
					<select class="select-amount" onchange="disableBuy(1)" id="select0">
          ...
          <div class="col-md-3" style="margin-bottom:10%">
			<div class="test">
				...
				<div class="footer">
					...
					<select class="select-amount" onchange="disableBuy(1)" id="select1">
						<option value=0>-- Amount --</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
		  ...
		  <div class="test">
			...
			<div class="footer">
				...
				<select class="select-amount" onchange="disableBuy(1)" id="select3">
					<option value=0>-- Amount --</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
